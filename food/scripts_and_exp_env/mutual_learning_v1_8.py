...
vit_config = {'num_workers': 8,
              ...
              'model_path': 'models/saved/vit_c1_baseline.pth',
              }
    ...
    while epoch < config['n_epochs']:
        ...
        for img, target in train_loader:
            ...
            if mode == 'train_res':
                ...
                res_loss = 0.3 * (lam * res_ce_loss(res_output, target_a) + (1 - lam) * res_ce_loss(res_output, target_b)) + 0.7 * res_kl_loss(log_probs, soft_targets)
                ...
                with autocast():
                    ...
                    vit_loss = 0.3 * (lam * vit_ce_loss(vit_output, target_a) + (1 - lam) * vit_ce_loss(vit_output,target_b)) + 0.7 * vit_kl_loss(log_probs, soft_targets)
