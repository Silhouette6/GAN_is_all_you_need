...
config = {'n_epochs': -1,
          ...
          'mix_ratio': 0.5694,
          'erase_ratio': 0.0,
          'running_mod': 'normal',  # 'normal' , 'finetune' or 'eval'
...
def get_dataloader(root, transform_train, transform_val, batch_size):
    flowers102_train = torchvision.datasets.Flowers102(root=root, split='train', download=True,
...
if __name__ == '__main__':
    ...
    if config['running_mod'] == 'eval':
        ...
        plot_confusion_matrix(cm,
                              ...
                              save_path=f"Plots/confusion_matrix_flower102_Comformer_{model_name}_{config['erase_ratio'] * 100}.png",
                              normalize=True)
    ...
    while epoch <= config['n_epochs']:
        ...
        if config['constant_save'] and epoch % 5 == 0:
            torch.save(conformer.state_dict(), f'models/finetune/com_trinity_{epoch}.pth')
